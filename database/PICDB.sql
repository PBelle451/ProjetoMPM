...
-- -----------------------------------------------------
-- Table `PIC`.`TD_FUNCOES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PIC`.`TD_FUNCOES` ;

CREATE TABLE IF NOT EXISTS `PIC`.`TD_FUNCOES` (
...
CREATE TABLE IF NOT EXISTS `PIC`.`TA_USUARIO_EMP` (
  ...
  CONSTRAINT `fk_TA_USUARIO_EMP_TB_FUNCOES1`
    ...
    REFERENCES `PIC`.`TD_FUNCOES` (`PK_FUNCOES`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PIC`.`TD_TPO_UNIDADE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PIC`.`TD_TPO_UNIDADE` ;

CREATE TABLE IF NOT EXISTS `PIC`.`TD_TPO_UNIDADE` (
  `PK_TPO_UNIDADE` INT NOT NULL AUTO_INCREMENT,
  `COD_TPO_UNIDADE` INT NOT NULL,
  `DESC_TPO_UNIDADE` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`PK_TPO_UNIDADE`),
  UNIQUE INDEX `PK_TPO_UNIDADE_UNIQUE` (`PK_TPO_UNIDADE` ASC),
  UNIQUE INDEX `COD_TPO_UNIDADE_UNIQUE` (`COD_TPO_UNIDADE` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `PIC`.`TD_TPO_CUSTO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PIC`.`TD_TPO_CUSTO` ;

CREATE TABLE IF NOT EXISTS `PIC`.`TD_TPO_CUSTO` (
  `PK_TPO_CUSTO` INT NOT NULL AUTO_INCREMENT,
  `COD_TPO_CUSTO` INT NOT NULL,
  `DESC_TPO_CUSTO` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`PK_TPO_CUSTO`))
ENGINE = InnoDB;
...
-- Table `PIC`.`TB_CUSTOS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PIC`.`TB_CUSTOS` ;

CREATE TABLE IF NOT EXISTS `PIC`.`TB_CUSTOS` (
  `PK_CUSTOS` INT NOT NULL AUTO_INCREMENT,
  `COD_CUSTOS` INT NOT NULL,
  `DESC_CUSTOS` VARCHAR(200) NOT NULL,
  `FK_PROJETO` INT NULL,
  `FK_UNIDADE` INT NOT NULL,
  `UNID_CUSTOS` DECIMAL(10) NOT NULL,
  `VALOR_CUSTOS` DECIMAL(10) NOT NULL,
  `VIGENCIA_TO_CUSTOS` DATE NULL COMMENT 'VIGENCIA APARTIR DE ',
  `VIGENCIA_ATE_CUSTOS` DATE NULL COMMENT 'VIGENCIA ATE ',
  `FK_EMPRESA` INT NOT NULL,
  `FK_CUSTO` INT NOT NULL,
  PRIMARY KEY (`PK_CUSTOS`),
  UNIQUE INDEX `PK_CUSTOS_UNIQUE` (`PK_CUSTOS` ASC),
  UNIQUE INDEX `COD_CUSTOS_UNIQUE` (`COD_CUSTOS` ASC),
  INDEX `fk_TB_CUSTOS_TD_TPO_UNIDADE1_idx` (`FK_UNIDADE` ASC),
  INDEX `fk_TB_CUSTOS_TB_EMPRESA1_idx` (`FK_EMPRESA` ASC),
  INDEX `fk_TB_CUSTOS_TB_PROJETO1_idx` (`FK_PROJETO` ASC),
  INDEX `fk_TB_CUSTOS_TD_TPO_CUSTO1_idx` (`FK_CUSTO` ASC),
  CONSTRAINT `fk_TB_CUSTOS_TD_TPO_UNIDADE1`
    FOREIGN KEY (`FK_UNIDADE`)
    REFERENCES `PIC`.`TD_TPO_UNIDADE` (`PK_TPO_UNIDADE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_CUSTOS_TB_EMPRESA1`
    FOREIGN KEY (`FK_EMPRESA`)
    REFERENCES `PIC`.`TB_EMPRESA` (`PK_EMPRESA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_CUSTOS_TB_PROJETO1`
    FOREIGN KEY (`FK_PROJETO`)
    REFERENCES `PIC`.`TB_PROJETO` (`PK_PROJETO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_CUSTOS_TD_TPO_CUSTO1`
    FOREIGN KEY (`FK_CUSTO`)
    REFERENCES `PIC`.`TD_TPO_CUSTO` (`PK_TPO_CUSTO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `PIC`.`TB_USUARIO`
-- -----------------------------------------------------
START TRANSACTION;
USE `PIC`;
INSERT INTO `PIC`.`TB_USUARIO` (`PK_USUARIO`, `FK_TPO_USUARIO`, `COD_USUARIO`, `EMAIL_USUARIO`, `TEL_USUARIO`, `SNA_USUARIO`) VALUES (1, 3, 1, 'some@mail.com', '61912341234', '$2b$10$reFLvWEtzJmYR5oSu6xXjuACNzhS2fbDmFZowdebAXZduB1d9/UhW');

COMMIT;


-- -----------------------------------------------------
-- Data for table `PIC`.`TD_FUNCOES`
-- -----------------------------------------------------
START TRANSACTION;
USE `PIC`;
INSERT INTO `PIC`.`TD_FUNCOES` (`PK_FUNCOES`, `COD_FUNCOES`, `DESC_FUNCOES`) VALUES (1, 1, 'Lider Maximo');
INSERT INTO `PIC`.`TD_FUNCOES` (`PK_FUNCOES`, `COD_FUNCOES`, `DESC_FUNCOES`) VALUES (2, 2, 'Gerente de Projeto');
INSERT INTO `PIC`.`TD_FUNCOES` (`PK_FUNCOES`, `COD_FUNCOES`, `DESC_FUNCOES`) VALUES (3, 3, 'Entrada/Consulta de Dados');

COMMIT;


-- -----------------------------------------------------
-- Data for table `PIC`.`TD_TPO_UNIDADE`
-- -----------------------------------------------------
START TRANSACTION;
USE `PIC`;
INSERT INTO `PIC`.`TD_TPO_UNIDADE` (`PK_TPO_UNIDADE`, `COD_TPO_UNIDADE`, `DESC_TPO_UNIDADE`) VALUES (1, 1, 'Dia');
INSERT INTO `PIC`.`TD_TPO_UNIDADE` (`PK_TPO_UNIDADE`, `COD_TPO_UNIDADE`, `DESC_TPO_UNIDADE`) VALUES (2, 2, 'Mes');
INSERT INTO `PIC`.`TD_TPO_UNIDADE` (`PK_TPO_UNIDADE`, `COD_TPO_UNIDADE`, `DESC_TPO_UNIDADE`) VALUES (3, 3, 'Ano');

COMMIT;


-- -----------------------------------------------------
-- Data for table `PIC`.`TD_TPO_CUSTO`
-- -----------------------------------------------------
START TRANSACTION;
USE `PIC`;
INSERT INTO `PIC`.`TD_TPO_CUSTO` (`PK_TPO_CUSTO`, `COD_TPO_CUSTO`, `DESC_TPO_CUSTO`) VALUES (1, 1, 'Variável');
INSERT INTO `PIC`.`TD_TPO_CUSTO` (`PK_TPO_CUSTO`, `COD_TPO_CUSTO`, `DESC_TPO_CUSTO`) VALUES (2, 2, 'Fixo');
INSERT INTO `PIC`.`TD_TPO_CUSTO` (`PK_TPO_CUSTO`, `COD_TPO_CUSTO`, `DESC_TPO_CUSTO`) VALUES (3, 3, 'Investimento');
